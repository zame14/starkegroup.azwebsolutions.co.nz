...
function downloadBrochure(form) {
    $.post('?ajax=download', $(form).serialize(), function (response) {
        if(response == "success") {
            $(".cta-form-success").fadeIn();
            doDownload();
        }
...
function doDownload() {
    window.open("/?ajax=download_brochure");
}
function resetForm() {
    $("#full_name").val("");
    $("#email").val("");
    $("#phone").val("");
    $("#message").val("");
    $("#brochure_full_name").val("");
    $("#brochure_email").val("");
    $(".cta-form-success").hide();
}
